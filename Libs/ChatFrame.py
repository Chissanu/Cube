...
class ChatFrame(ctk.CTkFrame):
    def __init__(self,master, chat, curUser, friendPic, **kwargs):
        ...
        if chat["name"] == self.curUser:
            print("here")
            # text label
            self.messages = ctk.CTkLabel(self, text=self.chat['text'],text_color="#000000", fg_color="#DCE9F6", font=("Inter", 30), wraplength=900, corner_radius=10)
            ...
            profile.grid(row = 0, column = 0, padx=30,pady = 30, sticky='w')
